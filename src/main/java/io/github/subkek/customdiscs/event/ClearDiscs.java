...
public class ClearDiscs implements Listener {
    ...
    public void onPlayerInteract(PlayerInteractEntityEvent event) {
        ...
        if (isAxe(player)) {
            ...
            itemMeta.getPersistentDataContainer().set(new NamespacedKey(io.github.subkek.customdiscs.CustomDiscs.getInstance(), "cleared"), PersistentDataType.STRING, "true");
        ...
        if (player.getInventory().getItemInMainHand().getType().equals(Material.GLOWSTONE_DUST)) {
            ...
            if (!data.get(new NamespacedKey(io.github.subkek.customdiscs.CustomDiscs.getInstance(), "cleared"), PersistentDataType.STRING).equals("true")) return;

            data.set(new NamespacedKey(io.github.subkek.customdiscs.CustomDiscs.getInstance(), "cleared"), PersistentDataType.STRING, "false");
